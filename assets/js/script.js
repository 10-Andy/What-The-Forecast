 ...
 /**All the query selectors set up  */
 ...
 /**Checking to see if there has been a location typed into the search bar before enter was hit  */
  ...
  * Catching the error and alerting the user when they have misspelled the city name
  */
 function getData(query) {
 ...
 /**Funtion for getting the data for the city searched and changhing the inner HTML */
 function displayData(weather) {
   ...
   /**Gets the Id from the weather API and selects the correct weather icon based on the id returned*/
